    ...
    (async function () {
        ...
        for (let i = 0; i < commentResult.length; i++) {
            ...
            commentResult[i].commenter = {
                ...
                avatar_url: commenterResult[0].avatar_url ? constant.QINIU_AVATAR_URL+commenterResult[0].avatar_url : '/news/images/worm.jpg'
            }
        ...
        authorResult[0].avatar_url=authorResult[0].avatar_url ? constant.QINIU_AVATAR_URL+authorResult[0].avatar_url :'/news/images/worm.jpg'
