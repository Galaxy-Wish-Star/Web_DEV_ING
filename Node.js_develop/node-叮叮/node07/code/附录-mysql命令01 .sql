...
--02 数据表的操作
    ...
    create table students(2id int unsigned primary key auto_increment,name varchar(30) not null,age int,high decimal(3,2),gender enum('男','女'),cls_id int unsigned);
...
+-------+------------------+------+-----+---------+----------------+
        ...
        insert into classes(name) values('赵六');
