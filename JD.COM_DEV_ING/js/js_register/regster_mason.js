window.onload = function () {
  ...
  function textStrong(password) {
    if (gz8.test(password.value) == true) {
      ...
      if (
        gz7.test(password.value) == true ||
        gz6.test(password.value) == true ||
        gz5.test(password.value) == true
      ) {
        n = 2;
      } else {
  ...
  btn.addEventListener("click", function () {
    if (
      ...
      if (
        gz1.test(phone.value) == true &&
        gz2.test(Emails.value) == true &&
        n != -1 &&
